...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'El correo electrónico ya está registrado.' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener lista de todos los usuarios' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Retorna la lista de usuarios.' }),
    __metadata("design:type", Function),
